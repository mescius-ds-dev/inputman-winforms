namespace InputManWin12_Demo._06_Display
{
    partial class PlaceHolder
    {
        ...
        private void InitializeComponent()
        {
            ...
            label10.Location = new Point(6, 248);
            ...
            gcComboBox1.Location = new Point(9, 269);
            ...
            gcComboBox1.Size = new Size(124, 50);
            ...
            label7.Location = new Point(135, 248);
            label7.Name = "label7";
            ...
            gcTime1.Location = new Point(136, 189);
            gcTime1.Margin = new Padding(2);
            gcTime1.Name = "gcTime1";
            gcTime1.PlaceHolder.Text = "終了時刻";
            gcTime1.Size = new Size(124, 50);
            gcTime1.TabIndex = 11;
            ...
            gcDate1.Location = new Point(8, 108);
            ...
            gcTimeSpan1.Location = new Point(8, 189);
            gcTimeSpan1.Name = "gcTimeSpan1";
            gcTimeSpan1.PlaceHolder.Text = "時間";
            gcTimeSpan1.Size = new Size(124, 50);
            ...
            gcDateTime1.Location = new Point(137, 108);
            ...
            gcDateTime1.Size = new Size(124, 50);
            ...
            gcTextBox1.Size = new Size(124, 50);
    ...
    0
            ...
            gcNumber1.Location = new Point(136, 269);
            gcNumber1.Name = "gcNumber1";
            gcNumber1.PlaceHolder.Text = "価格";
            gcNumber1.Size = new Size(124, 50);
            gcNumber1.TabIndex = 15;
            gcNumber1.Value = new decimal(new int[] { 10000, 0, 0, 0 });
            // 
            // label9
            // 
            label9.AutoSize = true;
            label9.Location = new Point(135, 168);
            label9.Name = "label9";
            ...
            label5.Location = new Point(135, 88);
            label5.Name = "label5";
            ...
            checkBox1.Size = new Size(207, 22);
            ...
            gcNumber2.Location = new Point(111, 32);
            gcNumber2.MaxValue = new decimal(new int[] { 15, 0, 0, 0 });
            gcNumber2.MinValue = new decimal(new int[] { 1, 0, 0, 0 });
            gcNumber2.Name = "gcNumber2";
            gcShortcut1.SetShortcuts(gcNumber2, new GrapeCity.Win.Editors.ShortcutCollection(new Keys[] { Keys.F2, Keys.Subtract, Keys.OemMinus, Keys.Control | Keys.Return }, new object[] { gcNumber2, gcNumber2, gcNumber2, gcNumber2 }, new string[] { "SetZero", "SwitchSign", "SwitchSign", "ApplyRecommendedValue" }));
            gcNumber2.SideButtons.AddRange(new GrapeCity.Win.Editors.SideButtonBase[] { spinButton1 });
            gcNumber2.Size = new Size(45, 24);
            gcNumber2.Spin.Wrap = false;
            gcNumber2.TabIndex = 5;
            gcNumber2.Value = new decimal(new int[] { 7, 0, 0, 0 });
