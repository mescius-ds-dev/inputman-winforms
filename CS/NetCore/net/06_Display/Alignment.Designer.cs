namespace InputManWin12_Demo._06_Display
{
    partial class Alignment
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.splitContainer1.Panel2.Controls.Add(this.gcNumber4);
            ...
            // gcTextBox1
            // 
            this.gcTextBox1.Location = new System.Drawing.Point(5, 28);
            ...
            this.gcShortcut1.SetShortcuts(this.gcTextBox1, new GrapeCity.Win.Editors.ShortcutCollection(new System.Windows.Forms.Keys[] {
                ...
                "ShortcutClear"}));
            this.gcTextBox1.Size = new System.Drawing.Size(260, 43);
            this.gcTextBox1.TabIndex = 1;
            this.gcTextBox1.Text = "テキストの配置を調整します";
            // 
            // label2
            // 
            ...
            this.gcNumber1.Location = new System.Drawing.Point(162, 56);
            ...
            this.spinButton1});
            this.gcNumber1.Size = new System.Drawing.Size(45, 24);
            ...
            subItem1.Value = "None";
            subItem2.Value = "均等割り付けを行いません。";
            listItem1.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem1,
            subItem2});
            subItem3.Value = "Distributed";
            subItem4.Value = "均等割り付けを行います。";
            listItem2.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem3,
            subItem4});
            subItem5.Value = "DistributedWithWhiteSpace";
            subItem6.Value = "均等割り付けを行いますが、行の両端に余白を確保します。";
            ...
            this.gcComboBox2.Location = new System.Drawing.Point(145, 162);
            ...
            this.gcComboBox2.Size = new System.Drawing.Size(118, 26);
            ...
            this.gcNumber3.Location = new System.Drawing.Point(205, 86);
            this.gcNumber3.Name = "gcNumber3";
            this.gcNumber3.SideButtons.AddRange(new GrapeCity.Win.Editors.SideButtonBase[] {
            this.spinButton3});
            this.gcNumber3.Size = new System.Drawing.Size(45, 24);
            this.gcNumber3.Spin.Wrap = false;
            this.gcNumber3.TabIndex = 7;
            ...
            this.gcNumber2.Location = new System.Drawing.Point(104, 86);
            this.gcNumber2.Name = "gcNumber2";
            this.gcNumber2.SideButtons.AddRange(new GrapeCity.Win.Editors.SideButtonBase[] {
            this.spinButton2});
            this.gcNumber2.Size = new System.Drawing.Size(45, 24);
            this.gcNumber2.Spin.Wrap = false;
            this.gcNumber2.TabIndex = 6;
            ...
            this.gcNumber4.Location = new System.Drawing.Point(162, 115);
            this.gcNumber4.Name = "gcNumber4";
            this.gcNumber4.SideButtons.AddRange(new GrapeCity.Win.Editors.SideButtonBase[] {
            this.spinButton4});
            this.gcNumber4.Size = new System.Drawing.Size(45, 24);
            this.gcNumber4.Spin.Wrap = false;
            this.gcNumber4.TabIndex = 9;
            this.gcNumber4.ValueSign = GrapeCity.Win.Editors.ValueSignControl.Positive;
            // 
            // spinButton4
            // 
            ...
            this.label8.Location = new System.Drawing.Point(173, 141);
            ...
            subItem7.Value = "TopLeft";
            subItem8.Value = "コンテンツは上端左寄せに配置されます。";
            listItem4.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem7,
            subItem8});
            subItem9.Value = "TopCenter";
            subItem10.Value = "コンテンツは上端中央に配置されます。";
            listItem5.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem9,
            subItem10});
            subItem11.Value = "TopRight";
            subItem12.Value = "コンテンツは上端右寄せに配置されます。";
            listItem6.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem11,
            subItem12});
            subItem13.Value = "MiddleLeft";
            subItem14.Value = "コンテンツは中段左寄せに配置されます。";
            listItem7.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem13,
            subItem14});
            subItem15.Value = "MiddleCenter";
            subItem16.Value = "コンテンツは中段中央に配置されます。";
            listItem8.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem15,
            subItem16});
            subItem17.Value = "MiddleRight";
            subItem18.Value = "コンテンツは中段右寄せに配置されます。";
            listItem9.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem17,
            subItem18});
            subItem19.Value = "BottomLeft";
            subItem20.Value = "コンテンツは下端左寄せに配置されます。";
            listItem10.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem19,
            subItem20});
            subItem21.Value = "BottomCenter";
            subItem22.Value = "コンテンツは下端中央に配置されます。";
            listItem11.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem21,
            subItem22});
            subItem23.Value = "BottomRight";
            subItem24.Value = "コンテンツは下端右寄せに配置されます。";
            ...
            this.gcComboBox1.Location = new System.Drawing.Point(145, 5);
            ...
            this.gcComboBox1.Size = new System.Drawing.Size(118, 26);
            ...
            this.Description = "コントロール内のテキストの配置を設定できます。コントロール内部の余白を設定したり、フォーカスがない時にテキストを均等割り付けしたりできます。";
