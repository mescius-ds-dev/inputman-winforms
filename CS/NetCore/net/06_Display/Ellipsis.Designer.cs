namespace InputManWin12_Demo._06_Display
{
    partial class Ellipsis
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.splitContainer1.Panel1.Controls.Add(this.gcComboBox2);
            // 
            ...
            this.gcTextBox1.Text = "綿100％洗えるキルティングラグ／ブラウン 140×200cm";
            // 
            // label2
            // 
            ...
            this.gcComboBox2.ImeMode = System.Windows.Forms.ImeMode.On;
            subItem1.Value = "綿100％洗えるキルティングラグ／ブラウン 140×200cm";
            listItem1.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem1});
            subItem2.Value = "綿100％洗えるキルティングラグ／ブラウン 200×200cm";
            listItem2.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem2});
            subItem3.Value = "綿100％洗えるキルティングラグ／ブラウン 200×240cm";
            listItem3.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem3});
            subItem4.Value = "綿100％洗えるキルティングラグ／ブラック 140×200cm";
            listItem4.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem4});
            subItem5.Value = "綿100％洗えるキルティングラグ／ブラック 200×200cm";
            listItem5.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem5});
            subItem6.Value = "綿100％洗えるキルティングラグ／ブラック 200×240cm";
            ...
            this.gcComboBox2.Location = new System.Drawing.Point(8, 161);
            ...
            this.gcComboBox2.Size = new System.Drawing.Size(260, 26);
            this.gcComboBox2.TabIndex = 5;
            // 
            // listColumn1
            // 
            this.listColumn1.AutoWidth = false;
            this.listColumn1.Header.Text = "トップ > 商品カテゴリー > インテリア > ラグ・マット";
            // 
            // dropDownButton1
            // 
            ...
            this.gcTextBox2.Location = new System.Drawing.Point(135, 36);
            ...
            this.gcShortcut1.SetShortcuts(this.gcTextBox2, new GrapeCity.Win.Editors.ShortcutCollection(new System.Windows.Forms.Keys[] {
                ...
                "ShortcutClear"}));
            this.gcTextBox2.Size = new System.Drawing.Size(128, 24);
            ...
            subItem7.Value = "None";
            subItem8.Value = "省略文字は表示しません。";
            listItem7.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem7,
            subItem8});
            subItem9.Value = "EllipsisEnd";
            subItem10.Value = "文字列の右側に省略文字を表示します。 （例： \"c:\\Program Files\\In…\"）";
            listItem8.SubItems.AddRange(new GrapeCity.Win.Editors.SubItem[] {
            subItem9,
            subItem10});
            subItem11.Value = "EllipsisPath";
            subItem12.Value = "ファイルパスの中央部分を省略文字に置き換えます。 （例： \"c:\\Program File…\\Bin\"）";
            ...
            this.gcComboBox1.Location = new System.Drawing.Point(135, 5);
            ...
            this.checkBox2.Location = new System.Drawing.Point(8, 110);
            this.checkBox2.Name = "checkBox2";
            this.checkBox2.Size = new System.Drawing.Size(279, 40);
            this.checkBox2.TabIndex = 5;
            this.checkBox2.Text = "コンボコントロールのリスト内の項目の末尾に\r\n省略文字[...]を表示する";
            ...
            this.checkBox1.Size = new System.Drawing.Size(231, 40);
            this.checkBox1.TabIndex = 4;
            this.checkBox1.Text = "コンボコントロールのヘッダの末尾に\r\n省略文字[...]を表示する";
            ...
            this.label6.Text = "テキスト（複数行）：";
            // 
            // gcTextBox3
            // 
            this.gcTextBox3.ImeMode = System.Windows.Forms.ImeMode.On;
            this.gcTextBox3.Location = new System.Drawing.Point(8, 76);
            this.gcTextBox3.Multiline = true;
            this.gcTextBox3.Name = "gcTextBox3";
            this.gcTextBox3.Size = new System.Drawing.Size(260, 62);
            this.gcTextBox3.TabIndex = 3;
            this.gcTextBox3.Text = "綿100％洗えるキルティングラグは、色はブラウンとブラック、サイズは 140×200cm／200×200cm／200×240cmの各種を取りそろえております。";
            // 
            // Ellipsis
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 18F);
            this.Description = "入力された文字列がコントロールよりも長い場合、省略文字によりコントロール内に表示しきれない文字列があることを知らせることができます。";
